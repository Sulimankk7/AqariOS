...
public class UpdateTenantEmergencyContactCommandValidator : AbstractValidator<UpdateTenantEmergencyContactCommand>
{
    ...
    public UpdateTenantEmergencyContactCommandValidator()
    {
