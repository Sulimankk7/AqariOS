...
namespace PropertyOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260704211902_Module4_Properties_Parking_Foundation")]
    partial class Module4_Properties_Parking_Foundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "audit_action_enum", "audit_action", new[] { "create", "update", "delete", "soft_delete", "restore", "login", "logout", "permission_change", "export", "status_change" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "audit_severity_enum", "audit_severity", new[] { "info", "warning", "critical" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "audit_source_enum", "audit_source", new[] { "api", "web", "mobile", "system_job", "admin_console" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "billing_cycle_enum", "billing_cycle_enum", new[] { "monthly", "yearly" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "building_type_enum", "building_type", new[] { "residential", "commercial", "mixed_use" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "floor_type_enum", "floor_type", new[] { "basement", "ground", "regular", "roof" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "governorate_enum", "governorate", new[] { "amman", "zarqa", "irbid", "balqa", "madaba", "karak", "tafilah", "maan", "aqaba", "ajloun", "jerash", "mafraq" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "late_fee_type_enum", "late_fee_type", new[] { "none", "fixed", "percentage" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "login_status_enum", "login_status", new[] { "success", "failed_password", "failed_locked", "failed_mfa", "failed_not_found" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "membership_status_enum", "membership_status", new[] { "invited_pending", "active", "suspended" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "mfa_type_enum", "mfa_type", new[] { "totp", "sms" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "occupancy_status_enum", "occupancy_status", new[] { "vacant", "occupied", "under_maintenance", "listed" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "otp_purpose_enum", "otp_purpose", new[] { "login", "phone_verification" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "ownership_status_enum", "ownership_status", new[] { "company_owned", "third_party_owned" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "parking_assignment_status_enum", "parking_assignment_status", new[] { "active", "ended" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "parking_type_enum", "parking_type", new[] { "standard", "covered", "visitor", "disabled_access" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "revoke_reason_enum", "revoke_reason", new[] { "rotated", "logout", "theft_detected", "admin_revoked", "expired" });
