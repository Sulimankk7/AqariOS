...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, null, "contract_document_type_enum", new[] { "signed_contract", "national_id_copy", "passport", "income_proof", "other" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, null, "contract_status_enum", new[] { "draft", "pending_signature", "active", "expired", "renewed", "terminated", "cancelled", "superseded" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, null, "legal_regime_enum", new[] { "standard", "old_rent_law" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, null, "payment_frequency_enum", new[] { "monthly", "quarterly", "semi_annual", "annual" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, null, "tenant_type_enum", new[] { "personal", "corporate" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, null, "termination_type_enum", new[] { "normal_expiration", "early_termination", "mutual_agreement", "tenant_request", "owner_request", "legal_eviction" });
