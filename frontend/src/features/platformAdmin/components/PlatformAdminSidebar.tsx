import { ClipboardList, CreditCard, Layers3, LayoutDashboard, MessageSquareText, Users } from "lucide-react";
...
export function PlatformAdminSidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const groups: NavigationGroup[] = [{ id: "platform", items: [
    ...
    { id: "administrators", label: t("platformAdmin.nav.administrators"), path: ROUTES.platform.administrators, icon: Users },
